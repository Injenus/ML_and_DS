...
# Описание данных для кластеризации и начальных положений кластеров
def pt(x, y, ind):
...
# Функции поиска ближайших центров и сдвига центров
def dist(p1, p2):
    dx = p1[0] - p2[0]
    dy = p1[1] - p2[1]
...
def checkAllPoints():
    for ind in range(0, len(pts)):
        # мняем цвет тчокина цвет ближайшего клстера
...
# Функции отрисовки и вывода на экран
def drawAll():
...
def main():
    ...
    print('Dist = {0}'.format(dist(pts[0], pts[1])))
